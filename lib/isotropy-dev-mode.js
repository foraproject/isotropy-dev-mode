(function() {
    ...
    KoaMode.prototype.init = function() {
        ...
        return co(function*() {
            ...
            page("*", window.__koa_in_browser.handlePageJSRequest.bind(window.__koa_in_browser));
            page.start();
    ...
    KoaMode.prototype.addStaticDirectories = function(staticDirectories, root) {
        ...
        this.isotropy.router.when(
            ...
            function*() {
                console.log("Request for static resource " + this.path);
                return false;
            }
        );
    };
